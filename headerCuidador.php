                    ...
                    <div class="12u">
                        <header id="header">
                            ...
                            <nav id="nav">
                                ...
                                <a href="versolicitudes.php" <?php echo ($currentPage == "verSolicitudes") ? ' class="current-page-item"' : '' ?>>Solicitudes</a>

                                <a href="login.php" <?php echo ($currentPage == "login") ? ' class="current-page-item"' : '' ?>>Cerrar sesión</a>
